...
class Main extends Component {
    state = {
        message: "Servey",
        question: ["Are You a good lisener ?",
         "Are you able to understandad things faster ?",
         "Are you a good person ?", 
         "How many years are you doing coding  ?",
          "Rate yourself in coding ...",
           "Rate in sucess yourself as you feel ...",
            "In humanity rate yourself ...",
             "Living style preference ...",
              "How many years of experience you have ?",
               "Rate yourself in general ..."],
